...
<div id="skills">
  ...
  <ul>
    <li>
      <h3>Traktor och Maskin i Sörmland AB</h3>
      <p>Arbetet varade mellan maj/juni någon gång till slutet av augusti.
         Kunden hade själv marknadsfört hemsidan på facebook tidigare och sett resultat från detta och kände nu att de behövde en lite uppfräschning av hemsidan för att kunna driva trafiken till något som ska kunna generera leads!
         En viktig punk för sidan var att driva trafiken till instagram och få folk kopplade till verksamheten,
         så att de sedan kan nås enkelt av marknadsföringen. Det ska även vara enkelt att nå säljarna via hemsidan.
          Den första kontakten med säljarna ska inte vara mer än några klick bort vart du än befinner dig på sidan.</p>
      </li>
      <li>
        <h3>Landqvist Handelsträdgård</h3>
        <p>Kunden var väldigt intresserad och hade utvecklat den tidigare hemsidan själv.
           Detta utvecklade en viss kravbild på att sidan skulle vara anpassningsbar.
            Det fanns även krav på att de skulle ha en instagram-feed på sidan i någon form,
          detta eftersom de är väldigt aktiva på den socialaplattformen och tar många bilder på trädgården dagligen.
          Arbetsprocessen var sådan att kunden berättade vilken funktionalitet de ville ha på sidan och hade inte riktigt några krav på sidans design,
          utan litade på att jag skulle ta fram några förslag. Efter lite bollande så kom vi fram till något som alla gillade.
          En informativ hemsida som inte är för krånglig. Eftersom att deras verksamhet är väldigt säsongsberoende så var de viktigt med de olika årstidernas öppettider högt upp på sidan,
          så att användarna ser det direkt när de kommer in på sidan.
          Nästa steg var att programmera sidan med Wordpress. Kunden ville ha sidan väldigt anpassningsbar och användarvänlig, det går alltså att byta färg och m.m genom wp-options-API. För instagram har jag använt instafeed.js. Kände att jag själv inte behövde gräva i API't för min lösning!</p>
        </li>
        <li>
          <h3>Trepe Bilvård</h3>
          <p>I detta projekt fick jag en lektion i branding och hur det är att förhålla sig till ett varumärke!
            Trepe bilvård är en del av Autoexperten och jag fick tillgång till deras intranet och alla guider och regler man måste förhålla sig till när man utvecklar något med deras varumärke.
            Kunden ville också att sidan skulle vara lik Moderhemsidan https://www.autoexperten.se/. här har jag även behövt bygga ut wordpress en del med custom posts och olika dynamiska fält.
            Det finns också möjligheten för kunder att "logga in" och begära en tid att komma till verkstan.
            Detta görs mot wordpress egna databas api och informationen kunderna fyller i sparas där och sedan kommer sidans administratörer åt  kunderna från wp-admin</p>
          </li>
  </ul>
</div>
</div>
